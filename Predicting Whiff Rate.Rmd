...
# I filtered out certain attributes to simplify the data set into what I would need to 
...
# I added suffix to the columns underneath to differentiate the attributes
...
# I then created the train and test data sets
