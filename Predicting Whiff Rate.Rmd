...
# Using the feature importance above I created a second model to gain a specific understanding of what predicts whiff rate based on the attributes of velocity and spin rate from each different pitch.
